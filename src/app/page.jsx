...
function page() {
  return (
    <div className='w-screen h-fit'>
      ...
      <div className="homenav fixed px-4 w-screen py-4 border-b flex items-center justify-between">
      ...
      <section id="home" className='w-screen min-h-screen flex flex-row px-4 bg-[url(/hero_shape.png)] bg-cover bg-purple-800 items-center justify-between'>
        <div className="w-[50%] h-full grid place-items-center">
          <div className="flex flex-col items-start gap-2">
            <h1 className='text-6xl tracking-wide text-purple-900 font-black'>Welcome <br />To Our Best <br /> E Learning Platform </h1>
