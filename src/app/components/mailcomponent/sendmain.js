export const resetpassword = ({ id, name, email }) => {
    return (
        <div style={{ background: "white", alignItems: 'center', padding: '2rem 1rem', borderRadius: "10px" }}>
            <a href="https://edulearnuln.vercel.app/_next/image?url=%2Fmailimg.jpg&w=128&q=75"><img src="https://edulearnuln.vercel.app/_next/image?url=%2Fmailimg.jpg&w=128&q=75" style={{width: "100%"}} alt="" /></a>
