...
function SideNavMob() {
    ...
    return (
        <motion.div initial={'initial'} animate={navmob ? 'enter' : 'exit'} exit={"exit"} variants={navvarient} className='h-full absolute z-[8] flex absolute left-0 overflow-x-hidden justify-end bg-[--web-container]'>
